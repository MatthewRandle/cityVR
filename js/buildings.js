...
//Building 3
var textureb3 = new THREE.TextureLoader().load( 'https://i.imgur.com/vDgZ0Ck.jpg' );
textureb3.wrapS = THREE.RepeatWrapping;
textureb3.wrapT = THREE.RepeatWrapping;
textureb3.repeat.set( 1, 1 );

var materialMediumBuilding2 = new THREE.MeshPhongMaterial({ 
  map: textureb3, 
  bumpMap: new THREE.TextureLoader().load( 'https://i.imgur.com/6XpfGBK.jpg' )
});
